...
import Carousel, { CarouselItem } from '../../components/custom-carousel/custom-carousel.component';
...
const WhoIsWatching = ({ history }) => {
    ...
    return (
        <div className='whoIsWatching-container'>
            ...
            <span className='whoIsWatching-title'><Title history={history} /></span>
            <CustomButton onClick={history.push('/accountpage')} className="whoswatching__account-button"><EngineeringTwoToneIcon /><span>ACCOUNT</span></CustomButton>
            ...
            <ul className='whoswatching__carousel-container'>
                ...
                <li><UserAvatar image={PeacockGreen} color={'#52f166'}
                /></li>
                <li><UserAvatar image={PeacockBlue} color={'#3071ff'}
                /></li>
                <li><img className='whoswatching__addAvatar-button' src={PlusSmall} alt='add button' />
                </li>
